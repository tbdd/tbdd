...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Storefront.analytics_footer'
        db.add_column('dhead_storefront', 'analytics_footer', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Storefront.analytics_footer'
        db.delete_column('dhead_storefront', 'analytics_footer')
    ...
    models = {
        ...
        'dhead.storefront': {
            ...
            'analytics_footer': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
